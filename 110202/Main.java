...
Potrebujeme:
    Vytvorime triedu karta, ktora bude udrzovat farbu a hodnotu kazdej karty.
    Dalej potrebuejme funkcie ktore budu vracat pre kazdy typ (dvojicu, trojicu, ...) konkretne cisla aj vzdhladom
        na to ake velke karty hrac ma.
